# Eksik veri ve veri kalitesi: Örnek 01

Kaynak: `chapters/pdr/03-eksik-veri-kalitesi.tex`. Kitaptaki sayısal öğretim örneği; yapay veri, 12 gözlem. Gruplar dosyada A=1, B=2 kodlanmıştır. Veriler yeniden rassal üretilmemiştir.
