...
Komutları `ornek-01` klasörünün içinden çalıştırın. Kitap projesinin
kökündeyseniz önce:

```sh
cd companion/bolumler/b01/ornek-01
```
...
2. SPSS çalışma dizinini bu `ornek-01` klasörüne ayarlayın. Çalışma dizini
   kitap projesinin köküyse Syntax penceresinde bir kez
   `CD 'companion/bolumler/b01/ornek-01'.` çalıştırın. Zaten örnek
